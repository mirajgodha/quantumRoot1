  ...
  try {
    ...
    if (
      ...
      const response: EnquiryResponse = {
        success: false,
        message: `Missing required fields. Please fill in all required information. ${enquiryData.name}, ${enquiryData.email}, ${enquiryData.phone}, ${enquiryData.course}, ${enquiryData.message}`,
      };
